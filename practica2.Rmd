...
# Creamos un histograma de aparición de los enlaces separando URLs absolutas y relativas.
plot1 <- ggplot(url_counts, aes(x = Links, y = count, fill = type)) +
...
plot2 <- ggplot(conteo_mediawiki, aes(x = "", y = freq, fill = es_mediawiki)) +
  ...
  coord_polar("y") +
  labs(title = "Porcentaje de status", fill = "Es mediawiki") +
